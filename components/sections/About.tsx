          ...
          <div>
            ...
            <AnimatedSection delay={0.1} className="mb-8">
              ...
              >
                ...
                <br />
                <span className="text-[#eec416]">{t.about.heading2}</span>
                <br />
                {t.about.heading3}
              </h2>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#555] text-xs" style={{ fontFamily: "var(--font-inter)" }}>{t.about.itbaFull}</p>
                </div>
              </a>
            </AnimatedSection>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {team.map((member, i) => {
                ...
                const isNeighbor = hovered !== null
                  ...
                  && !isHovered;
                const displayRole = lang === "en" ? (member.role === "Coordinador" ? "Coordinator" : member.role) : member.role;
                const displayCareer = lang === "en" ? (member.careerEn ?? member.career) : member.career;
                          ...
                          {isHovered ? isMobile ? (
                            ...
                            >
                              ...
                              <div className="absolute inset-x-0 top-0 p-3 flex gap-2" onClick={e => e.stopPropagation()}>
                                <a href={`mailto:${member.email}`} className="flex items-center justify-center w-8 h-8 rounded-full bg-[#1a1a1a] border border-[#2a2a2a] text-[#666] hover:bg-[#2b281a] hover:border-[#eec416]/40 hover:text-[#eec416] active:text-[#eec416] transition-colors duration-200">
                                ...
                                {member.linkedin && (
                                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 h-8 rounded-full bg-[#1a1a1a] border border-[#2a2a2a] text-[#666] hover:bg-[#2b281a] hover:border-[#eec416]/40 hover:text-[#eec416] active:text-[#eec416] transition-colors duration-200">
                              ...
                              <div className="absolute inset-x-0 bottom-0 p-4">
                                ...
                                <p className="text-[#eec416]/60 text-xs uppercase tracking-wider" style={{ fontFamily: "var(--font-inter)" }}>{displayRole}</p>
                              </div>
                            </motion.div>
                          ) : (
                            <motion.div
                            ...
                            >
                              <div className="relative shrink-0" style={{ width: COLLAPSED_H }}>
                                {member.photo ? (
                                  ...
                                  <div className="w-full h-full bg-[#eec416]/10 flex items-center justify-center">
                                    <span className="text-[#eec416] text-2xl" style={{ fontFamily: "var(--font-syne)", fontWeight: 600 }}>{initials(member.name)}</span>
                                  </div>
                                )}
                              </div>
                              <div className="flex flex-col justify-center px-5 flex-1 min-w-0">
                                ...
                                <p className="text-[#eec416]/50 text-xs uppercase tracking-wider mb-1" style={{ fontFamily: "var(--font-inter)" }}>{displayRole}</p>
                                <p className="text-[#666] text-xs leading-snug mb-3" style={{ fontFamily: "var(--font-inter)" }}>{displayCareer}</p>
                                <div className="flex flex-col gap-1.5 mt-1">
                                  <a href={`mailto:${member.email}`} className="inline-flex items-center gap-1.5 text-[#555] text-xs hover:text-[#eec416] transition-colors duration-200 truncate" style={{ fontFamily: "var(--font-inter)" }}>
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="shrink-0"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                                    {member.email}
                                  </a>
                                  {member.linkedin && (
                                    <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-[#555] text-xs hover:text-[#eec416] transition-colors duration-200" style={{ fontFamily: "var(--font-inter)" }}>
                                      <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="shrink-0"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                                      LinkedIn
                                    </a>
                                  )}
                                </div>
                            ...
                            >
                              {photoSrc ? (
                                <Image src={photoSrc} alt={member.name} fill sizes="(max-width: 640px) 50vw, 180px" className="object-cover" />
                              ) : (
                                <div className="w-full h-full bg-[#eec416]/10 flex items-center justify-center">
                                  <span className="text-[#eec416] text-2xl" style={{ fontFamily: "var(--font-syne)", fontWeight: 600 }}>{initials(member.name)}</span>
                                </div>
                              ...
                              <div className="absolute inset-x-0 bottom-0 p-3">
                                ...
                                <p className="text-[#eec416]/60 text-[10px] uppercase tracking-wider leading-tight" style={{ fontFamily: "var(--font-inter)" }}>{displayRole}</p>
                              </div>
                            </motion.div>
                          ) : (
                            <motion.div
                            ...
                            >
                              ...
                              <p className="text-white text-sm font-medium leading-snug mb-1" style={{ fontFamily: "var(--font-syne)", fontWeight: 700 }}>{member.name}</p>
                              <p className="text-[#555] text-xs uppercase tracking-wider mb-1" style={{ fontFamily: "var(--font-inter)" }}>{displayRole}</p>
                              <p className="text-[#444] text-xs leading-snug" style={{ fontFamily: "var(--font-inter)" }}>{displayCareer}</p>
