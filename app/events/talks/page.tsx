...
export const metadata: Metadata = {
  ...
  description:
    "Charlas íntimas con emprendedores reales en el ITBA.",
};
        ...
        <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <AnimatedSection delay={0.2}>
            <p
              ...
              style={{ fontFamily: "var(--font-inter)" }}
            >
              Charlas íntimas con emprendedores reales. No figuras
              corporativas, personas con historias concretas para contar.
            </p>
          </AnimatedSection>
        </section>
            ...
            <AnimatedSection direction="none">
              <div className="relative w-full h-[55vh] md:h-[65vh] overflow-hidden">
                ...
                <div className="absolute bottom-8 left-6 md:bottom-12 md:left-12">
                  ...
                  <p
                    className="text-[#888] text-sm mt-2 uppercase tracking-widest"
                    style={{ fontFamily: "var(--font-inter)" }}
                  >
                    {edition.speakerRole}
                  </p>
