...
export const metadata: Metadata = {
  ...
  description: "We visit the offices of the companies building the future.",
};

export default function EnVisitsPage() {
  return (
    <>
        ...
        <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-[#777] text-lg leading-relaxed max-w-xl" style={{ fontFamily: "var(--font-inter)" }}>
              We visit the offices of the companies building the future. An inside look at how the teams changing industries actually work.
            </p>
          </AnimatedSection>
        </section>
          ...
          <article key={edition.id} id={edition.id} className="mb-8 md:mb-12">
            <AnimatedSection direction="none">
              <div className="relative w-full h-[55vh] md:h-[65vh] overflow-hidden">
                <Image src={edition.coverImage} alt={edition.company} fill className="object-cover" sizes="100vw" priority={i === 0} />
