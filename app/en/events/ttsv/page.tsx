...
export const metadata: Metadata = {
  ...
  description: "Tech Trek Silicon Valley: a trip to learn from the global entrepreneurial ecosystem.",
};

export default function EnTTSVPage() {
  return (
    <>
        ...
        <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-[#777] text-lg leading-relaxed max-w-xl" style={{ fontFamily: "var(--font-inter)" }}>
              A trip to learn from the global entrepreneurial ecosystem and bring that knowledge back to the Argentine community.
            </p>
          </AnimatedSection>
        </section>
          ...
          <article key={edition.year} id={`ttsv-${edition.year}`} className="mb-8 md:mb-12">
            <AnimatedSection direction="none">
              <div className="relative w-full h-[55vh] md:h-[65vh] overflow-hidden">
                <Image src={edition.coverImage} alt={`Tech Trek Silicon Valley ${edition.year}`} fill className="object-cover" sizes="100vw" priority={i === 0} />
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 pt-12 pb-4">
              <div className="max-w-2xl mb-6 space-y-5">
                {(edition.paragraphsEn ?? edition.paragraphs).map((para, j) => (
                  <AnimatedSection key={j} delay={j * 0.05}>
                    <p className="text-[#777] text-base md:text-lg leading-relaxed" style={{ fontFamily: "var(--font-inter)" }}>
                      {para}
                    </p>
                  </AnimatedSection>
                ))}
              ...
              <AnimatedSection delay={0.2} className="max-w-2xl mb-14">
                <p className="text-[#444] text-sm" style={{ fontFamily: "var(--font-inter)" }}>
