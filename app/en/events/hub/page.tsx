...
export const metadata: Metadata = {
  ...
  description: "The main Tech Trek event. Over 300 students, leading companies and entrepreneurs all in one place.",
};
            ...
            {i === 0 ? (
              <AnimatedSection direction="none">
                <div className="relative w-full h-[55vh] md:h-[65vh] overflow-hidden">
                  <Image src={hubPage.coverImage} alt={`Tech Trek Hub ${edition.year}`} fill className="object-cover" sizes="100vw" priority />
              ...
              <div className="max-w-7xl mx-auto px-6 md:px-12 mt-20 md:mt-28">
                <AnimatedSection>
                  <div className="flex items-end justify-between pb-6 border-b border-[#1f1f1f] mb-10">
                    <div>
                      <p className="text-[#eec416] text-xs uppercase tracking-[0.3em] mb-2" style={{ fontFamily: "var(--font-inter)" }}>
                        Previous edition
                      </p>
                      <h2
                        className="text-white uppercase leading-none tracking-tighter"
                        style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(2rem, 5vw, 4rem)" }}
                      >
                        Hub {edition.year}
                      </h2>
                    </div>
                    <span
                      ...
                      style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "5rem", lineHeight: 1 }}
                    >
                      {edition.year}
                    </span>
                  </div>
